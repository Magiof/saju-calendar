...
export type YongsinUse = {
  element: string;
  stems: string[];
  reason: string;
};

export type YongsinUseDetail = YongsinUse & {
...
export type SajuResult = {
  ...
  advanced: {
    ...
    yongsin: string[];
    yongsinDetail: {
      johu: YongsinUseDetail | null;
      eokbu: YongsinUseDetail | null;
    };
    sinsal: { names: string[] };
    sinsalDetail: {
      core: string[];
